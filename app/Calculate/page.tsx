...
export default function Component() {
  ...
  const calculateCalories = () => {
    ...
    if (gender === "male") {
      ...
      bmr = 447.593 + 9.247 * weightValue + 3.098 * heightValue - 4.33 * ageValue;
    }

    const tdee = bmr * activityValue;

    setResult(`Your daily calorie needs are about: ${tdee.toFixed(2)} calories.`);
  };
      ...
      <Card className="w-full max-w-3xl p-8">
        ...
        <CardContent className="grid gap-6 mt-6 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={gender} onChange={(e) => setGender(e.target.value)} onChange={(e) => setGender(e.target.value)}>
          ...
          <div className="space-y-2 col-span-2">
            ...
            <Select value={activityLevel} onChange={(e) => setActivityLevel(e.target.value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="extraActive">Super active (very hard exercise/sports & physical job)</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </CardContent>
